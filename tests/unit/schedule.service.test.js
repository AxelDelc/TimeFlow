const { validateSlotHours, validateConsecutiveHours, validateWeeklyHours } = require('../../src/services/schedule.service');
...
describe('validateConsecutiveHours', () => {
  it('accepte une durée inférieure à la limite', () => {
    expect(validateConsecutiveHours(
      new Date('2024-01-01T09:00:00Z'),
